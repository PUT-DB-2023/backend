# Generated by Django 4.0.5 on 2022-09-15 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=30)),
                ('additional_info', models.CharField(max_length=100)),
                ('editionServer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.editionserver')),

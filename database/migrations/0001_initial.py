...
def forwards_func(apps, schema_editor):
    ...
    with open('logins.csv', 'w') as f:
        writer = csv.writer(f)
        writer.writerow(['user_type', 'login', 'password'])
        print('Admin:\n')

        writer.writerow(['admin', 'admin@cs.put.poznan.pl', 'admin'])
        print(f"Password for admin@cs.put.poznan.pl is admin")
        ...
        for i in range(4):
            ...
            writer.writerow(['teacher', email, password])
        ...
        for i in range(4, len(users_names)):
            ...
            writer.writerow(['student', email, password])
            print(f"Password for {email} is {password}")
